                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      decoration: const BoxDecoration(color: Color(0xFF660033), shape: BoxShape.circle, boxShadow: [BoxShadow(color: Colors.black26, blurRadius: 4)]),
                      child: const Icon(Icons.directions_car, color: Colors.white, size: 20),
                    ),
                    const Icon(Icons.arrow_drop_down, color: Color(0xFF660033), size: 15),
                  ],
                ),
              ),
          ],
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Text(distanceInfo, style: const TextStyle(color: Color(0xFF660033), fontWeight: FontWeight.bold, fontSize: 12)),

...
class _AdminOrderDetailsScreenState extends State<AdminOrderDetailsScreen> {
  ...
  /// يفتح منتقي التاريخ ثم الوقت (بثيم العلامة #660033) لتعديل موعد الزيارة.
  Future<void> _pickSchedule() async {
    final DateTime base = _editedSchedule ?? DateTime.now();
    const brand = Color(0xFF660033);
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            const Icon(Icons.event, color: Color(0xFF660033), size: 20),
                            const SizedBox(width: 10),
                            Expanded(
                              child: Text(
                            ...
                            const Icon(Icons.edit_calendar, color: Color(0xFF660033), size: 20),
                          ],
                        ),
                      ),
                    ),

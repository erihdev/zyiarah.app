                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(color: const Color(0xFF660033), borderRadius: BorderRadius.circular(8)),
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: const Color(0xFF660033).withValues(alpha: 0.2)),
                  ),
                  child: Row(
                    children: [
                      const Icon(Icons.info_outline, color: Color(0xFF660033), size: 22),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: _agreeToTerms ? const Color(0xFF660033) : Colors.grey.shade300,
                      foregroundColor: Colors.white,
                    ),
                    child: _isSubmitting

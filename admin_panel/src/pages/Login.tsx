...
export default function Login() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center font-tajawal relative bg-slate-50" dir="rtl">
            {/* Background elements — بهوية التطبيق (بنفسجي #660033) */}
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute -top-[20%] -right-[10%] w-[70%] h-[70%] rounded-full bg-gradient-to-br from-[#660033]/10 to-[#A85782]/5 blur-3xl opacity-80"></div>
                <div className="absolute top-[40%] -left-[10%] w-[50%] h-[50%] rounded-full bg-gradient-to-tr from-[#660033]/[0.07] to-rose-50 blur-3xl opacity-60"></div>
            ...
            <div className="relative w-full max-w-[420px] px-6">
                <div className="bg-white/90 backdrop-blur-2xl rounded-3xl p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/60">
                    ...
                    <div className="text-center mb-10">
                        <div className="mx-auto w-20 h-20 bg-white rounded-2xl flex items-center justify-center shadow-lg shadow-[#660033]/25 ring-1 ring-slate-100 overflow-hidden mb-6">
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        <div className="space-y-5">
                            <div className="relative group">
                                <div className="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none text-slate-400 group-focus-within:text-[#660033] transition-colors duration-300">
                                ...
                                <input
                                    ...
                                    className="w-full bg-slate-50 border border-slate-200 text-slate-800 text-sm rounded-2xl focus:ring-4 focus:ring-[#660033]/10 focus:border-[#660033] block py-4 pr-12 pl-4 transition-all duration-300 outline-none font-medium placeholder-slate-400"
                        ...
                        <div className="flex items-center justify-between text-sm mt-6 mb-8">
                            <label htmlFor="remember-me" className="flex items-center text-slate-600 cursor-pointer group">
                                <div className="relative flex items-center justify-center w-5 h-5 ml-2">
                                    ...
                                    <div className="w-5 h-5 rounded-md border-2 border-slate-300 peer-checked:bg-[#660033] peer-checked:border-[#660033] transition-colors flex items-center justify-center">
                            ...
                            <a href="#" className="font-bold text-[#660033] hover:text-[#4D0026] transition-colors">نسيت كلمة المرور؟</a>
                        </div>

                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full relative flex items-center justify-center space-x-2 space-x-reverse text-white bg-[#660033] overflow-hidden font-bold rounded-2xl text-lg px-5 py-4 text-center transition-all duration-300 disabled:opacity-70 group hover:shadow-xl hover:shadow-[#660033]/30"
                        >
                            <div className="absolute inset-0 bg-gradient-to-r from-[#660033] to-[#A85782] opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                            {isLoading ? (

    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-8">
                <div className="bg-white p-6 rounded-[20px] shadow-sm border border-slate-100/60 flex items-center justify-between group hover:border-[#d9b8db] transition-colors">
                    ...
                    <div className="w-12 h-12 bg-[#f7f0f8] text-[#5D1B5E] rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform"><ShieldCheck size={24} /></div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 p-6 bg-slate-50/30">
                    {filteredDrivers.length === 0 ? (
                        ...
                        <div key={driver.id} className="bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow p-5 relative overflow-hidden group">
                            <div className="absolute top-0 right-0 w-32 h-32 bg-slate-50 rounded-bl-full -z-10 group-hover:bg-[#f7f0f8]/50 transition-colors duration-500"></div>
                            ...
                            <div className="flex gap-2">
                                <button type="button" onClick={() => openEdit(driver)} className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-xl text-sm font-bold border border-[#d9b8db] text-[#5D1B5E] hover:bg-[#f7f0f8] transition-colors"><Pencil size={14} />تعديل</button>
                    ...
                    <div className="bg-white rounded-[24px] shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
                        ...
                        <form onSubmit={handleSaveEdit} className="p-6 space-y-5">
                            ...
                            <div className="space-y-2">
                                ...
                                <input type="text" required value={editForm.name} onChange={e => setEditForm({ ...editForm, name: e.target.value })} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 outline-none focus:border-[#5D1B5E] focus:ring-2 focus:ring-[#5D1B5E]/20 transition-all font-medium" />
                            </div>
                            <div className="space-y-2">
                                <label className="block text-sm font-extrabold text-slate-700">رقم الجوال</label>
                                <input type="tel" required value={editForm.phone} onChange={e => setEditForm({ ...editForm, phone: e.target.value })} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 outline-none focus:border-[#5D1B5E] focus:ring-2 focus:ring-[#5D1B5E]/20 transition-all font-medium" dir="ltr" />
                            </div>
                            <div className="space-y-2">
                                <label className="block text-sm font-extrabold text-slate-700">بيانات المركبة</label>
                                <input type="text" value={editForm.vehicle} onChange={e => setEditForm({ ...editForm, vehicle: e.target.value })} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 outline-none focus:border-[#5D1B5E] focus:ring-2 focus:ring-[#5D1B5E]/20 transition-all font-medium" />
                            </div>
                            <div className="space-y-2">
                                <label className="block text-sm font-extrabold text-slate-700">الراتب الشهري (ر.س)</label>
                                <input type="number" aria-label="الراتب الشهري" min="0" value={editForm.monthly_salary || ''} onChange={e => setEditForm({ ...editForm, monthly_salary: Number(e.target.value) })} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 outline-none focus:border-[#5D1B5E] focus:ring-2 focus:ring-[#5D1B5E]/20 transition-all font-medium" dir="ltr" />
                            </div>
                            <div className="pt-2 flex gap-3">
                                ...
                                <button disabled={isSaving} type="submit" className="flex-1 px-4 py-3 bg-[#5D1B5E] text-white rounded-xl font-bold hover:bg-[#4a1149] transition-colors flex justify-center items-center disabled:opacity-70">

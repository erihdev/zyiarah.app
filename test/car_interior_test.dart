...
void main() {
  ...
  group('شاشة العميل — نمط المكيفات', () {
    ...
    test('التعريف الذي طلبه المالك ظاهر: تنظيف مراتب داخلية السيارة', () {
      // حُذف ذكر «أسقف السيارة» و«بالبخار والتعقيم» بطلب المالك.
      expect(carScreen.contains('تنظيف عميق لداخلية السيارة: المراتب (المقاعد)'),
          isTrue);
      expect(carScreen.contains('بالبخار والتعقيم'), isFalse);
    });
  });

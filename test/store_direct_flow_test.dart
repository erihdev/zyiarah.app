...
/// (قرار المالك 2026-07-18) مسار المتجر **المباشر** — يبقى الآن لـ **متجر الشركات**
/// فقط (بعد أن صار متجر الأدوات والتنظيف مجدولاً 2026-07-21، انظر
/// store_client_scheduled_test): العميل يدفع فوراً (بلا موعد)، وبعد تأكيد الدفع
/// تديره الإدارة نقرةً نقرة: تحت المراجعة ⇒ جاري التوصيل ⇒ تم التوصيل — والعميل
/// يرى كل نقلة حيّاً (بثّ Firestore) ويصله إشعار خادمي لحظي. هذا المسار (createStoreOrder
/// + StorePaymentScreen + store_orders) سليم بالكامل ويجب أن يبقى لمتجر الشركات.
void main() {
